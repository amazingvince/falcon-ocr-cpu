...
KIND = "fp32-frozen-state-crossover-v1"
PINS = {
...
CONTROL_STAGES = ["layer.8.q", "layer.8.k", "layer.8.v", "layer.8.attention",
                  "layer.8.hidden", "layer.9.v"]
REQUIRED_SOURCES = {
    ...
    *{"experiments/fp32_crossover/" + name for name in (
...
def validate_plan(plan, *, check_files=True):
    ...
    require(plan.get("original_state_key") == "layer.7.hidden"
