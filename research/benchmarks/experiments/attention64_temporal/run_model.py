...
PINS = {
    ...
    "research/benchmarks/experiments/cache_layout/capture_temporal_model_v2.py": "629be9702c587cb68dd66c22c7762ed96e2b1ff62bf475f78ab3795ce2082414",
    "research/benchmarks/experiments/cache_layout/compare_temporal_model_saved_v1.py": "c23d207f48513a02777dad145754ed31183e19b33019663abae24c5c64e8dee2",
}
...
def load_helpers(window, preparation):
    ...
    for name in ["patch", "capture"]:
        ...
        if name == "capture":
            current = module
    oldpath = ROOT / "research/benchmarks/experiments/cache_layout/capture_temporal_model_v2.py"
...
def run(args):
    ...
    try:
        ...
        need(inv == {"command": ["powershell.exe", "-NoProfile", "-ExecutionPolicy", "Bypass", "-File",
                                  str(project / "tools/build_windows.ps1"), "test", "--locked", "--release",
