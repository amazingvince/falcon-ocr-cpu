...
def main():
    ...
    names = ["Cargo.lock", "rust-toolchain.toml", "src/kernels.rs",
             "research/gpu-reference/experiments/linear/observed_partition_probe/Cargo.toml",
             "research/gpu-reference/experiments/linear/observed_partition_probe/Cargo.lock",
             "research/gpu-reference/experiments/linear/observed_partition_probe/src/main.rs",
             "research/gpu-reference/experiments/linear/capture_observed_partition_probe.py"]
