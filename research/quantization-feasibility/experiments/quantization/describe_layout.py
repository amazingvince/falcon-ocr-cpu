...
report = {"schema_version": 1, "created_utc": datetime.datetime.now(datetime.timezone.utc).isoformat(),
          ...
          "source_sha256": {p: sha(p) for p in ["research/quantization-feasibility/experiments/quantization/q4_reference.rs", "research/quantization-feasibility/experiments/quantization/isa_probe.rs", "research/quantization-feasibility/experiments/quantization/describe_layout.py"]},
          "scalar_tests": {"command": "rustc --edition 2024 --test research/quantization-feasibility/experiments/quantization/q4_reference.rs -C opt-level=1 -o artifacts/quantization/q4-reference-tests.exe; artifacts/quantization/q4-reference-tests.exe --test-threads 1",
