...
python experiments/cache_layout/capture_temporal_candidate.py --output artifacts/diagnostics/prefix-temporal-candidate-review-v1 --prepare-only
python experiments/cache_layout/capture_temporal_candidate.py --output artifacts/diagnostics/prefix-temporal-candidate-windows-v1
```
