...
Negative provenance tests are in `research/quantization-feasibility/tests/test_quantization_provenance.py`.
...
```powershell
rustc --edition 2024 --test research/quantization-feasibility/experiments/quantization/q8_reference.rs -C opt-level=1 -o artifacts/quantization/q8-reference-tests.exe
artifacts/quantization/q8-reference-tests.exe --test-threads 1
python research/quantization-feasibility/experiments/quantization/check_probe.py --self-test
python research/quantization-feasibility/experiments/quantization/capture_probe.py --output artifacts/quantization/operator-probe-v1 --run
```
...
```powershell
python research/quantization-feasibility/experiments/quantization/capture_avx2_probe.py --output artifacts/quantization/q4-avx2-operator-NEW
python research/quantization-feasibility/experiments/quantization/capture_avx2_probe.py --check artifacts/quantization/q4-avx2-operator-v1
```
