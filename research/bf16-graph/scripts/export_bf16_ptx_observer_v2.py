...
def main():
    ...
    try:
        ...
        sources = ["research/bf16-graph/scripts/export_bf16_ptx_observer_v2.py", "research/bf16-graph/scripts/instrument_bf16_ptx_v2.py",
                   "research/bf16-graph/scripts/bf16_ptx_observer_support_v2.py", "scripts/cuda_ptx_reference.py",
                   "research/bf16-graph/scripts/test_bf16_ptx_observer_v2.py", "reference/bf16-ptx-observer-spec-v2.json",
                   ...
                   "scripts/reference_preflight.py", "scripts/fetch_reference.py", "research/bf16-graph/scripts/run_bf16_ptx_observer_v2.sh",
