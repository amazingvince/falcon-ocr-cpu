...
def main():
    ...
    manifest = {"schema_version": 3, "status": "visually_reviewed_selection_frozen_materialization_and_duplicate_audit_pending",
                ...
                "review": {"path": review_path, "sha256": hashlib.sha256(report_bytes).hexdigest(), "inherited_v2_review_sha256": sha("reference/corpus-v2-visual-review.json"), "selector_sha256": sha("research/corpus-qualification/scripts/select_corpus_v3.py")},
