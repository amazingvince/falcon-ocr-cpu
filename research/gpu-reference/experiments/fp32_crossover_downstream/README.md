...
python research/gpu-reference/experiments/fp32_crossover_downstream/prepare.py --quiet-window-released --output artifacts/diagnostics/fp32-crossover-downstream-plan-v1
```
