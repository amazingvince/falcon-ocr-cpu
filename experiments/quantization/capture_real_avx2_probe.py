...
def capture(directory):
    ...
    commands = [[rustc, str(ROOT / "experiments/quantization/q4_real_avx2_probe.rs"), "--edition", "2024", "-C", "opt-level=3", "-o", str(binary)],
                [rustc, str(ROOT / "experiments/quantization/q4_avx2_probe.rs"), "--edition", "2024", "-C", "opt-level=3", "--test", "-o", str(tests)]]
