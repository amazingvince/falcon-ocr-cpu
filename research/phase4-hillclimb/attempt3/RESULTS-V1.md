...
- **Run schedule:** `research/phase4-hillclimb/attempt3/bench.py --schedule interleaved --control-every 2`. Each arm is one fresh process with 1 warmup and 2 samples. Arms ran in this order:
