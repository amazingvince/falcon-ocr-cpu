...
| T7 | Adaptive drafting (`draft::DraftPolicy`): draft only while the running acceptance rate beats the measured break-even `extra_ms / single_ms`, with a probe every 16 steps | Pending A/B. | |
