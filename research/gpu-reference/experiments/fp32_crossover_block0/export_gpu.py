...
REQUIRED_SOURCES = {
    "research/gpu-reference/experiments/fp32_crossover_block0/export_gpu.py", "research/gpu-reference/experiments/fp32_crossover_block0/contract.py",
...
def accepted_cpu_execution(args, plan, bound):
    ...
    require(cpu["source_sha256"]["arm"] == plan["source_sha256"]["research/gpu-reference/experiments/fp32_crossover_block0/rust_arm.rs"]
