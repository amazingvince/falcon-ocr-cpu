...
```powershell
& 'C:\Users\amazi\mambaforge\python.exe' research/benchmarks/experiments/profiling/capture_windows.py prepare --output 'D:\falcon-ocr-rust-builds\profiles\fullpage-expanded-v2'
```
...
```powershell
& 'C:\Users\amazi\mambaforge\python.exe' research/benchmarks/experiments/profiling/capture_windows.py run --plan 'D:\falcon-ocr-rust-builds\profiles\fullpage-expanded-v2\plan.json' --expected-plan-sha256 '<reviewed digest>'
```
