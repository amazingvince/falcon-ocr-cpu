...
```powershell
& C:/Users/amazi/mambaforge/python.exe scripts/capture_functional_cli.py --output artifacts/builds/functional-cli-v1-windows --jobs 2
& C:/Users/amazi/mambaforge/python.exe scripts/functional_batch_regression.py --build artifacts/builds/functional-cli-v1-windows/build.json --output artifacts/functional-batch/mixed-b4-v1
```
...
```powershell
& C:/Users/amazi/mambaforge/python.exe scripts/functional_batch_regression.py --plan artifacts/functional-batch/mixed-b4-v1/plan.json --run
```
