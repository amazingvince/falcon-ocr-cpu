...
spec = importlib.util.spec_from_file_location("quant_checker", ROOT / "research/quantization-feasibility/experiments/quantization/check_probe.py")
...
class QuantProvenanceTests(unittest.TestCase):
    def setUp(self):
        ...
        sources["research/quantization-feasibility/experiments/quantization/check_probe.py"] = b"historical checker"
    ...
    def test_valid_historical_checker_is_distinct_from_current_checker(self):
        ...
        self.assertEqual(result["archived_original_checker_sha256"], self.hashes["research/quantization-feasibility/experiments/quantization/check_probe.py"])
