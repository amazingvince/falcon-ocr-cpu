...
sys.path.insert(0, str(Path(__file__).resolve().parents[3] / "research/corpus-qualification/scripts"))  # compare_original_supplement moved here in the 2026-09-24 archive
