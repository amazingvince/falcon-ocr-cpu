#!/usr/bin/env python3
"""One reviewed stores-only PTX observer; full controls gate every observation."""
import argparse
import hashlib
import json
import os
...
from instrument_bf16_ptx import build, restore, ROUNDTRIP_SHA, PROBES, BUFFER_BYTES
from bf16_ptx_observer_support import ObserverModule, decode_buffer, arithmetic_inventory
...
def main():
    ...
    parser.add_argument("--output", type=pathlib.Path, default=pathlib.Path("artifacts/reference/bf16-ptx-observer-v1"))
    ...
    try:
        ...
        spec_path = root / "reference/bf16-ptx-observer-spec-v1.json"
        bind(spec_path)
        ...
        sources = ["scripts/export_bf16_ptx_observer.py", "scripts/instrument_bf16_ptx.py",
                   "scripts/bf16_ptx_observer_support.py", "scripts/cuda_ptx_reference.py",
                   "scripts/test_bf16_ptx_observer.py", "reference/bf16-ptx-observer-spec-v1.json",
