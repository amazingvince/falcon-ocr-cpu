...
```powershell
& C:/Users/amazi/mambaforge/python.exe experiments/quantization/capture_real_avx2_probe.py --output artifacts/quantization/q4-real-avx2-operator-NEW
```

Recheck preserved evidence without changing it:

```powershell
& C:/Users/amazi/mambaforge/python.exe experiments/quantization/capture_real_avx2_probe.py --check artifacts/quantization/q4-real-avx2-operator-v1 --report artifacts/quantization/q4-real-avx2-operator-v1/recheck-NEW.json
```
