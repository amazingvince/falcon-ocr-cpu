...
def category(names):
    ...
    if "attention_with_simd" in joined or "attention_compact_with_simd" in joined or COMPACT_HEAD.search(joined):
...
def summarize(path, expected_pid):
    ...
    return {
        "kind": "perfview-compact-cpu-stack-summary-v1",
        ...
        "limits": [
            ...
            "Exact qualified compact_head/compact worker closure is attention; inlined dot/PV shares cannot be recovered from function-only stacks.",
