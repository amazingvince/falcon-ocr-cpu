...
FOLDER = ROOT / "artifacts/benchmarks/attention64-staged-fullpage-window-v1"
OUTPUT = ROOT / "reference/benchmarks/windows-attention64-staged-fullpage-review-v1.json"
PLAN_SHA = "45730ca2ed26fe63facd1dafb004701711ace5cc50e8a8b0c4d92fb37ab0d6b0"
bound = {}
checks = 0
...
def main():
    ...
    with zipfile.ZipFile(io.BytesIO(payload(protocol_path))) as archive:
        check(len(archive.namelist()) == 2 and set(archive.namelist()) == {"research/benchmarks/experiments/profiling/benchmark_compact_candidate.py", "research/benchmarks/scripts/realistic_benchmark.py"}, "Protocol archive inventory")
    ...
    receipt={"schema_version":1,"kind":"windows-attention64-staged-fullpage-independent-review-v1","status":"passed_saved_result_review","plan_sha256":PLAN_SHA,
