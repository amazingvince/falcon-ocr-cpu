...
"""Blinded LLM-as-judge packets for OCR outputs, and the unblinded report.
  ...
  python research/phase4-hillclimb/attempt3/judge_pages.py build --lock reference/corpus-v3-evaluation-lock.json \
  ...
  python research/phase4-hillclimb/attempt3/judge_pages.py report --out artifacts/phase4/judge/handwriting
