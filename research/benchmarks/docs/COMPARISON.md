...
`research/benchmarks/scripts/compare_focr.py`; its unit tests are `research/benchmarks/scripts/test_compare_focr.py`.
...
`research/benchmarks/docs/PERFORMANCE.md`) and `expanded`. Commit and binary hashes are in each
...
- **Output agreement** from the cold runs with stop tokens (11, 263) stripped:
  ...
  reference on 200 pages (`research/benchmarks/docs/STATUS.md`); his is validated against the
...
(`research/benchmarks/docs/PERFORMANCE.md`); expanded caches measured 69.2 s here. Peak resident
