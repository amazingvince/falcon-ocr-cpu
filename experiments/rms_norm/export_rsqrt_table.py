...
SOURCE_PATHS = (
    "experiments/rms_norm/export_rsqrt_table.py",
    "experiments/rms_norm/rsqrt_lookup.rs",
    "experiments/rms_norm/rsqrt_lookup_probe.rs",
    "experiments/rms_norm/test_export_rsqrt_table.py",
