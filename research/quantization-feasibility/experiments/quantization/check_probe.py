...
COMPILED_SOURCES = {"probe": "examples/quant_probe.rs", "q4": "research/quantization-feasibility/experiments/quantization/q4_reference.rs",
                    "q8": "research/quantization-feasibility/experiments/quantization/q8_reference.rs", "cargo_lock": "Cargo.lock"}
...
def validate_preserved_build(report, report_path, build_path=None):
    ...
    checker_key = "research/quantization-feasibility/experiments/quantization/check_probe.py"
