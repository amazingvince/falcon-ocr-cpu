...
from instrument_bf16_ptx import (PROBES, FIELDS, FINAL_FIELDS, VECTOR_FIELDS, CAPACITY,
...
def decode_buffer(raw, layer):
    ...
    return result, {"expected_cells": len(expected), "actual_cells": len(actual), "complete_unique_write_coverage": True}
