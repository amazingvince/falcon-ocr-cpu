#!/usr/bin/env python3
"""One explicit temporal-prefix B1 candidate between pinned compact CPU controls."""
import argparse
import hashlib
import json
...
KIND = "single-page-temporal-candidate-bracket-v1"
...
SOURCE_ADDITIONS = ("src/temporal_candidate.rs", "src/temporal_model_tests.rs")
...
def prepare(args):
    ...
    plan = {"kind": KIND, "created_utc": rb.utc(),
            ...
            "jobs": JOBS,
            "limitations": ["One full page: compact control versus explicit temporal candidate; B1 uses the single-page path, not joint multirow throughput.",
