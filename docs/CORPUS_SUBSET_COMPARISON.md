...
```sh
python scripts/compare_cpu_corpora.py \
  --manifest reference/corpus-v3-smoke-lock.json \
...
```sh
python scripts/test_corpus_comparison.py
python scripts/test_validate_text_replay.py --replay artifacts/cpu/corpus-v3-fp32-4096-redecoded-v2
python scripts/test_validate_gpu_reference_record.py
```
