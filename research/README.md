...
| [resolution-router/](resolution-router/README.md) | 11 | The per-page image-size router: agreement labels, serving noise, the ground-truth development set and the chosen tree policy. Active. |
| [reviews-2026-09-20/](reviews-2026-09-20/README.md) | 6 | Code and math reviews of 2026-09-20 that shaped the phase-4 plan. |
| [vllm-serving/](vllm-serving/README.md) | 17 | Production-style BF16 serving with vLLM and the held-out comparisons made through it. |
