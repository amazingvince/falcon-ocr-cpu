...
[model graph](../../src/model.rs) have 22 layers, residual width 768, 16 query
...
For attention, [current kernels](../../src/kernels.rs) use query tiles of 32 and
...
softmax; see [its results](../../experiments/attention64_compact/RESULTS-V1.md).
...
The local [AOCL experiment](../AOCL.md) uses the separate weekly revision
