...
def main():
    ...
    paths=source_paths()
    controls=[Path(__file__).resolve(),HERE/"temporal_candidate.rs",HERE/"temporal_model_tests.rs",HERE/"test_temporal_candidate.py",ROOT/"tools/build_windows.ps1"]+[ROOT/n for n in PINS]
