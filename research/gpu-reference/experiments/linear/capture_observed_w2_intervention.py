...
PROBE = ROOT / "research/gpu-reference/experiments/linear/observed_partition_probe/src/main.rs"
...
def main():
    ...
    controls = [Path(__file__).resolve(), PROBE, ROOT / "research/gpu-reference/experiments/linear/test_observed_w2_intervention.py",
                ROOT / "tools/build_windows.ps1", ROOT / "research/gpu-reference/scripts/compare_traces.py"]
