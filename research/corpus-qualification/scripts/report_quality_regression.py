...
def report(manifest_path, comparison_path, *, expected_manifest_sha256=V3_SHA256,
    ...
    frozen_dir = script_dir.parents[2] / "scripts"  # the frozen GPU-reference closure (2026-09-24 archive)
    source_code_hashes = {}
    for name in ("report_quality_regression.py", "corpus_comparison.py", "validate_text_replay.py",
        ...
        path = bound_file(candidate if candidate.exists() else frozen_dir / name)
