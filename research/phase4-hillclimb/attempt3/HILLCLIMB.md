...
## Offline output-error proxy (`research/phase4-hillclimb/attempt3/w8_output_error.py`)
...
Offline activation-weighted output error (`research/phase4-hillclimb/attempt3/dtype_proxy.py`) agrees: INT16 0.0025%, FP16 0.024%, BF16 0.19%, GPTQ INT8 0.12%, INT4 10–12%. BF16 is dominated as a storage type; 4-bit is out for this model.
