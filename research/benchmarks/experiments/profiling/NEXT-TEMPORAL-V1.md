...
The existing `research/benchmarks/experiments/attention64/candidate.rs::dot64` already expresses
...
Reuse `research/benchmarks/experiments/cache_layout/temporal_candidate.rs` storage and append
...
`research/benchmarks/experiments/cache_layout/capture_temporal_candidate.py::patch_copy`:
