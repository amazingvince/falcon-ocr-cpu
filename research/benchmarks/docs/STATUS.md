...
the previous default is recorded in `research/benchmarks/docs/PERFORMANCE.md`
(`artifacts/benchmarks/attention64-promotion-v1/`). The same session added the
first matched external comparison, `research/benchmarks/docs/COMPARISON.md`, against the Rust/GGML
...
ours-only compact rows were rerun; `research/benchmarks/docs/COMPARISON.md` labels each row's layout.
...
See `research/benchmarks/experiments/toolchain_194/RESULTS-V1.md`. The first RTen 0.26 probe builds
...
`research/benchmarks/experiments/head_contiguous_prefix/RESULTS-V1.md`. Matrix-kernel comparisons
...
`research/benchmarks/experiments/profiling/FULLPAGE-RESULTS-V1.md`. The first isolated candidate
...
`research/benchmarks/experiments/attention64/RESULTS-V1.md`. This isolated candidate is not promoted
...
`research/benchmarks/experiments/attention64_compact/RESULTS-V1.md`. This proves an added gain over
...
See `research/benchmarks/experiments/gemv_pair/RESULTS-V1.md`.
...
See `research/benchmarks/experiments/attention64_temporal/RESULTS-V1.md`.
...
- The pinned official document component evaluator produces identical CPU/GPU
  ...
  historical. See `reference/official-components-v3-fp32.json` and `research/corpus-qualification/docs/EVALUATION.md`.
...
- INT4 feasibility and an isolated scalar reference are documented in
  `research/quantization-feasibility/docs/QUANTIZATION.md`. No quantized production backend or speed/quality result
...
`research/gpu-reference/experiments/linear/OWNED-WORKSPACE.md` and
...
- The selected 200-page corpus and 24-page smoke output comparisons are complete;
  ...
  The separate [quality accounting](../../corpus-qualification/docs/QUALITY.md) revalidates original/replayed
...
- Qualify matrix batching across platforms and workloads, packed weight/cache improvements,
  ...
  The independently reviewed [full-page functional batch protocol](../../corpus-qualification/docs/FUNCTIONAL_BATCH_REGRESSION.md)
...
See `research/quantization-feasibility/experiments/quantization/AVX2-RESULTS-V1.md`.
...
See `research/quantization-feasibility/experiments/quantization/REAL-AVX2-RESULTS-V1.md`.
