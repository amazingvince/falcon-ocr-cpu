"""One unchanged warmed-decode allocation test after operators and exact smoke."""
import json
import os
...
def main():
    ...
    need(smoke['kind'] == 'gemv-pair-smoke-v1' and smoke['status'] == 'bit_exact'
    ...
    report = {'kind': 'gemv-pair-allocations-v1', 'status': 'failed',
