...
sys.path.insert(0, str(Path(__file__).resolve().parents[3] / "research/benchmarks/scripts"))  # capture_rust_build moved here in the 2026-09-24 archive

import capture_rust_build as capture

ROOT = capture.ROOT
PROTOCOL_FILES = ["research/corpus-qualification/scripts/capture_functional_cli.py", "research/corpus-qualification/scripts/functional_batch_regression.py",
                  "research/corpus-qualification/scripts/corpus_comparison.py", "research/corpus-qualification/scripts/validate_text_replay.py", "scripts/fetch_reference.py"]
