...
FOLDER = ROOT / "artifacts/benchmarks/attention64-compact-fullpage-window-v1"
OUTPUT = ROOT / "reference/benchmarks/windows-attention64-compact-fullpage-review-v1.json"
PLAN_SHA = "2647716915e89f9bc4cccb51b4fdee6db3ebbaba3fbf8b0628c68ae02c13396a"
bound = {}
checks = 0
...
def main():
    ...
    receipt={"schema_version":1,"kind":"windows-attention64-compact-fullpage-independent-review-v1","status":"passed_saved_result_review","plan_sha256":PLAN_SHA,
