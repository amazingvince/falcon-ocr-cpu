...
SCRIPT_FILES = ["research/benchmarks/scripts/realistic_benchmark.py", "research/benchmarks/scripts/compare_realistic_benchmarks.py"]
...
def validate_build(path, check_current=True):
    ...
    required = {"Cargo.toml", "Cargo.lock", "rust-toolchain.toml", "examples/ocr_bench.rs",
                "research/benchmarks/scripts/capture_rust_build.py", "tools/build_windows.ps1", "tools/build_linux.sh"}
    if check_current:
