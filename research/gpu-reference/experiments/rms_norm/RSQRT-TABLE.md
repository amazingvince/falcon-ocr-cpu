...
The capture completed with zero result or mapping mismatches across all 1,266,679,808 requested GPU arguments. The preserved Rust probe then matched all 1,057 observed boundary outputs exactly; canonical input ordering and all artifact hashes were rechecked. The [validation receipt](../../../../reference/rsqrt-table-rust-validation-v1.json) binds the evidence. Table SHA-256: `218fc04d271773269367dedf4cff9ff719081b1218c3d67d248d8d6126040246`. GPU report SHA-256: `ae662d30fc8a82a20318114d98ebeba8fe619b7ed7359e736bced931e96315d2`.
...
```text
<pinned-reference-python> research/gpu-reference/experiments/rms_norm/export_rsqrt_table.py --output artifacts/reference/rsqrt-canonical-table-fp32-v1 --chunk-size 1048576
```
