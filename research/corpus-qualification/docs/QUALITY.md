...
`research/corpus-qualification/scripts/report_quality_regression.py` adds a separate fail-closed accounting
...
```bash
python research/corpus-qualification/scripts/report_quality_regression.py \
...
Twenty bounded tests in `research/corpus-qualification/tests/test_quality_regression.py` cover complete200,
