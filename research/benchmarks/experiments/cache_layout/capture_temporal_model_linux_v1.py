...
PINS = {
    ...
    "tools/build_linux.sh": "25203d4275f25a786bc91531f36d1ebe25ae77736d0dd59b7af1832b0f759e76",
}
CAPTURE_FILES = ["experiments/cache_layout/" + name for name in [
    ...
    "test_temporal_model_capture_v2.py", "test_temporal_model_saved_v1.py"]] + ["tools/build_linux.sh"]
NATIVE_CAPTURE_FILES = ["research/benchmarks/experiments/cache_layout/capture_temporal_model_v2.py",
    "research/benchmarks/experiments/cache_layout/test_temporal_model_capture_v2.py", "tools/build_windows.ps1",
...
def build(path):
    ...
    try:
        for label, target in targets.items():
            ...
            command = ["bash", str(ROOT / "tools/build_linux.sh"), "test", "--offline", "--locked", "--release", "--no-run",
