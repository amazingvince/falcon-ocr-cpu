...
`python research/benchmarks/scripts/compare_benchmark_modes.py` with the recorded filenames.
...
Reproduce with `research/benchmarks/scripts/benchmark_packed_windows.ps1` and summarize with
`research/benchmarks/scripts/compare_packed_benchmarks.py`. Retained samples and hashes are in
...
`bracket.md`), produced by `research/benchmarks/scripts/promotion_bracket.py`; the control and
