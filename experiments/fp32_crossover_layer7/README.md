...
python experiments/fp32_crossover_layer7/capture.py --quiet-window-released prepare --output artifacts/diagnostics/fp32-crossover-layer7-v1
python experiments/fp32_crossover_layer7/capture.py --quiet-window-released build --prepared artifacts/diagnostics/fp32-crossover-layer7-v1 --preparation-sha256 <hash> --target-dir D:/falcon-ocr-rust-builds/fp32-crossover-layer7-v1
python experiments/fp32_crossover_layer7/capture.py --quiet-window-released run --prepared artifacts/diagnostics/fp32-crossover-layer7-v1 --preparation-sha256 <hash> --build-sha256 <hash>
```
